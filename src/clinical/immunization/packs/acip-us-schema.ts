...
export type AcipRuleKind = "routine" | "catch_up" | "special_population" | "campaign" | "outbreak" | "review_only";
export type AcipOfficialStatus = "current" | "superseded" | "stayed" | "unknown";
export const acipUsPackSchema = z.object({
