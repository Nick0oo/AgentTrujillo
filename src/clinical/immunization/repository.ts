...
export type PersistedCountryChangeRun = Readonly<{ outcome: "created" | "idempotent_replay"; runId: string; assessmentIds: readonly string[] }>;
...
export type ImmunizationRepository = Readonly<{
  ...
  saveCountryChangeRun: (scope: AuthorizedChildScope, input: CountryChangeRunWrite, signal?: AbortSignal) => Promise<ImmunizationRepositoryResult<PersistedCountryChangeRun>>;
}>;
