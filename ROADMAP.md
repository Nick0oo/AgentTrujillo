...
- Product implementation: module `02` completed; module `03` is in progress with `AT-03-01` through `AT-03-04`, `AT-03-07`, and `AT-03-08` completed.
- First active executable unit after module-02 verification: `AT-03-05`.
...
| 03 | Clinical governance | completed | in progress (`AT-03-01` through `AT-03-04`, `AT-03-07`, and `AT-03-08` completed) | Only approved, versioned, checksum-matching packages resolve | [Module 03](roadmap/03-clinical-governance/README.md) |
...
| 14 | Model fallback, observability, and evals | completed | pending | Fallback parity and privacy gates have zero critical failures | [Module 14](roadmap/14-model-fallback-observability-and-evals/README.md) |
| 15 | Deployment and production | completed | pending | Colombia rollout, rollback, security, clinical, and operational gates pass | [Module 15](roadmap/15-deployment-and-production/README.md) |
...
|---|---|---|
| `AT-03-05` | Active approved package resolver | `AT-03-07` and `AT-03-08` complete |
