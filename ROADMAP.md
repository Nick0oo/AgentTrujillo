...
- Atomic roadmap authoring: modules `01` through `03` completed; module `04` in progress on branch `codex/agent-roadmap-harness`.
...
| 04 | Safety and emergency boundary | in progress | pending | Critical red flags bypass the LLM and emit approved emergency-only copy | [Module 04](roadmap/04-safety-and-emergency-boundary/README.md) |
