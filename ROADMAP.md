...
- Product implementation: module `02` completed; module `03` is in progress with `AT-03-01` through `AT-03-04` and `AT-03-08` completed.
- First active executable unit after module-02 verification: `AT-03-07`.
...
| 03 | Clinical governance | completed | in progress (`AT-03-01` through `AT-03-04` and `AT-03-08` completed) | Only approved, versioned, checksum-matching packages resolve | [Module 03](roadmap/03-clinical-governance/README.md) |
...
|---|---|---|
| `AT-03-07` | Dr. Trujillo approval gate | `AT-03-03` and `AT-03-04` commits complete |
