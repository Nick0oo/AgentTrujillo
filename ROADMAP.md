...
- Atomic roadmap authoring: `in_progress` on branch `codex/agent-roadmap-harness`.
...
|---|---|---:|---:|---|---|
| 01 | Runtime and harness | in progress | pending | Safe Eve surface with Gemini baseline and discovery gate | [Module 01](roadmap/01-runtime-and-harness/README.md) |
| 02 | Access and session isolation | pending | pending | Zero cross-space, cross-child, and cross-session access | [Module 02](roadmap/02-access-and-session-isolation/README.md) |
