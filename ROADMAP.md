...
- Atomic roadmap authoring: modules `01` through `14` completed; module `15` in progress on branch `codex/agent-roadmap-harness`.
...
| 15 | Deployment and production | in progress | pending | Colombia rollout, rollback, security, clinical, and operational gates pass | [Module 15](roadmap/15-deployment-and-production/README.md) |
