...
- Product implementation: module `02` completed; module `03` is in progress with `AT-03-01` completed and `AT-03-02` ready.
- First active executable unit after module-02 verification: `AT-03-02`.
...
| 03 | Clinical governance | completed | in progress (`AT-03-01` completed) | Only approved, versioned, checksum-matching packages resolve | [Module 03](roadmap/03-clinical-governance/README.md) |
...
|---|---|---|
| `AT-03-02` | Canonical rule-pack artifact format | `AT-03-01` commit `cfc8801` |
