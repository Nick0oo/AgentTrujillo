...
- Product implementation: module `02` completed; module `03` is in progress with `AT-03-01` through `AT-03-10` completed; only `AT-03-11` remains.
- First active executable unit after module-02 verification: `AT-03-11`.
...
| 03 | Clinical governance | completed | in progress (`AT-03-01` through `AT-03-10` completed) | Only approved, versioned, checksum-matching packages resolve | [Module 03](roadmap/03-clinical-governance/README.md) |
...
|---|---|---|
| `AT-03-11` | Clinical governance evals | `AT-03-10` complete |
