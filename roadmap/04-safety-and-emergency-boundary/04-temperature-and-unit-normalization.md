...
- [ ] Arithmetic is exact and locale-independent.
- [ ] Units/method/time remain explicit.
- [ ] Ambiguity never becomes reassurance.
- [ ] Thresholds are package data, not code constants.
- [ ] Boundary corpus is clinically approved.
