---
id: AT-08-05
title: Package approved nutrition content
module: 08-nutrition-and-development
status: pending
execution: sequential
parallel_group: null
depends_on: [AT-08-01, AT-03-11]
blocks: [AT-08-06, AT-08-07, AT-08-08]
worker:
  model: gpt-5.6-luna
  reasoning: max
...
touches:
  create:
    - src/clinical/nutrition/content-loader.ts
    - tests/clinical/nutrition/content-loader.test.ts
  modify: []
  test:
    - tests/clinical/nutrition/content-loader.test.ts
exclusive_paths:
...
commit:
  message: "feat(nutrition): package approved nutrition content"
---

## Outcome

Versioned Colombia-first and US-ready nutrition blocks resolve only from released, rights-cleared, translated packages.
...
AT-08-01, AT-03-11 and the approved sources, licenses, and contracts named below.
...
Versioned Colombia-first and US-ready nutrition blocks resolve only from released, rights-cleared, translated packages. Exact schemas, provenance, deterministic behavior, fail-closed states, tests, and evidence are included.
...
Export NutritionContentManifest and loadNutritionContent with tags, citations, jurisdiction/age/effective ranges, license and digest.

## Technical design

Canonical non-executable fragments are schema/source/license/checksum/approval verified; CO and US never merge.
...
Content cannot promise prevention/treatment, endorse products, or exceed feeding/choking/allergy boundaries.
...
Cover missing rights/source/translation, digest drift, duplicate IDs, prohibited phrases, country mix and revocation; also fixed cutoff, stable digest/order, revocation, scope mismatch, and atomicity where applicable.
...
Commit exclusive paths with feat(nutrition): package approved nutrition content; no remote mutation, activation, or unrelated edit.
