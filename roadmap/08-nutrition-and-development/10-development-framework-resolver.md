---
id: AT-08-10
title: Resolve caregiver-safe framework
module: 08-nutrition-and-development
status: pending
execution: sequential
parallel_group: null
depends_on: [AT-08-09, AT-03-11]
blocks: [AT-08-11, AT-08-16]
worker:
  model: gpt-5.6-luna
  reasoning: max
...
touches:
  create:
    - src/clinical/development/framework-resolver.ts
    - tests/clinical/development/framework-resolver.test.ts
  modify: []
  test:
    - tests/clinical/development/framework-resolver.test.ts
exclusive_paths:
...
commit:
  message: "feat(development): resolve caregiver-safe framework"
---

## Outcome

A resolver selects one released, rights-cleared caregiver framework while keeping EAD-3 professional-only.
...
AT-08-09, AT-03-11 and the approved sources, licenses, and contracts named below.
...
A resolver selects one released, rights-cleared caregiver framework while keeping EAD-3 professional-only. Exact schemas, provenance, deterministic behavior, fail-closed states, tests, and evidence are included.
...
Export resolveDevelopmentFramework returning audience/version/source/license/approval digests or unavailable reason.

## Technical design

Require exact country/effective/locale/rights and caregiver audience; reject professional artifacts. Non-screening disclaimer is mandatory.
...
Milestones are communication aids, not standards, screens, diagnostic criteria, or proof of normality.
...
Cover country/locale/effective bounds, missing rights, professional injection, revocation, overlap and disclaimer drift; also fixed cutoff, stable digest/order, revocation, scope mismatch, and atomicity where applicable.
...
Commit exclusive paths with feat(development): resolve caregiver-safe framework; no remote mutation, activation, or unrelated edit.
