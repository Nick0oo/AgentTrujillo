...
select * from public.create_owned_agent_session('00000000-0000-0000-0000-000000001011', '00000000-0000-0000-0000-000000001021', 'm:1:a:1', now() + interval '4 minutes', 'evaluation', 'fixture', '{}');
...
select ok((select owner_user_id = '00000000-0000-0000-0000-000000001002' from public.create_owned_agent_session('00000000-0000-0000-0000-000000001011', '00000000-0000-0000-0000-000000001021', 'm:1:a:1', now() + interval '4 minutes', 'evaluation', 'fixture', '{}')), 'co-guardian can create only its own session');

set local role anon;
select set_config('request.jwt.claim.sub', '', true);
select throws_ok($sql$select * from public.create_owned_agent_session('00000000-0000-0000-0000-000000001011', '00000000-0000-0000-0000-000000001021', 'm:1:a:1', now() + interval '4 minutes', 'evaluation', 'fixture', '{}')$sql$, '42501', null, 'anonymous create grant denied');
...
select ok((select count(*) = 0 from public.create_owned_agent_session('00000000-0000-0000-0000-000000001011', '00000000-0000-0000-0000-000000009999', 'm:1:a:1', now() + interval '4 minutes', 'evaluation', 'fixture', '{}')), 'cross-child create returns zero rows');
select ok((select count(*) = 0 from public.create_owned_agent_session('00000000-0000-0000-0000-000000009999', '00000000-0000-0000-0000-000000001021', 'm:1:a:1', now() + interval '4 minutes', 'evaluation', 'fixture', '{}')), 'cross-space create returns zero rows');
